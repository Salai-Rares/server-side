...
export class TagConditionVO extends DiscountConditionVO {
  ...
  constructor(operator: "equals" | "in", value: string | string[]) {
    ...
    if (operator === "equals" && typeof value !== "string") {
      throw ValidationError.domainRule("conditions.value", "invalid_type", "Tag equals must be string");
    }
    if (operator === "in" && !Array.isArray(value)) {
      throw ValidationError.domainRule("conditions.value", "invalid_type", "Tag in must be array of strings");
    }
